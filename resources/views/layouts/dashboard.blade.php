            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <div class="mb-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('spare-parts.index') }}" class="sidebar-item flex items-center px-3 py-3 rounded-xl text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 {{ request()->routeIs('spare-parts.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-500' : '' }}">
                        ...
                        <a href="{{ route('tow-trucks.index') }}" class="sidebar-item flex items-center px-3 py-3 rounded-xl text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 {{ request()->routeIs('tow-trucks.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-500' : '' }}">
